    ...
    const attackSlides = [
        {
            image: "images",
            title: "Basics",
            description: `A territory can attack one of its 8 neighbouring territories or through a link if it has 2+ troops. \n
